...
//}
//
//void Node::addPoint(std::vector<std::shared_ptr<mypt3d>> & pts){
//	if (m_isLeaf) {
...
//}
//
//void Node::dividePoints(std::vector<std::shared_ptr<mypt3d>>& pts) {
//
//	std::vector<std::vector<std::shared_ptr<mypt3d>>> childVecs;
//	childVecs.resize(8);
//
//
...
//	std::vector<std::shared_ptr<mypt3d>> pts = m_file.readFromFile(m_numPoints);
//	std::vector<std::vector<std::shared_ptr<mypt3d>>> childVecs;
//
//
//	childVecs.resize(8);
